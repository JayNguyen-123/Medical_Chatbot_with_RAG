...
# config Generative AI model
model = genai.GenerativeModel('gemini-2.0-flash-exp')
my_api_key_gemini = os.getenv('GOOGLE_API_KEY')
genai.config(api_key=my_api_key_gemini)
...
# Define your 404 error handler to redirect to index page
...
def upload():
    ...
    try:
        ...
        logger.error("An error occurred while processing the PDF: %s", e)
